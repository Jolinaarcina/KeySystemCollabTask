...
class MysqliDb
{
     ...
     * @param string $socket
     */
    public function MysqliDb($host = null, $username = null, $password = null, $db = null, $port = null, $charset = 'utf8', $socket = null)
    {
        $isSubQuery = false;
    ...
    public function connect($connectionName = 'default')
    {
        ...
        try {
            ...
            echo '<div class = "alert alert-danger">Caught exception: ',  $e->getMessage(), "\n";
        } 
    }
